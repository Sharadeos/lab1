...
// declared an instance of the class, which makes it global
...
void check_mouse(XEvent *e)
{
	...
	if (e->type == MotionNotify) {
		...
		if (savex != e->xbutton.x || savey != e->xbutton.y) {
			savex = e->xbutton.x;
            //mirrored the y axis using the resolution
